...
def skipgram(current_center_word, outside_words, word2ind, center_word_vectors, outside_vectors, dataset, word2vec_loss_and_gradient=neg_sampling_loss_and_gradient):
  ...
  # For each context word, compute the loss and gradients for the (center, outside) pair
  for outside_word in outside_words:
    loss_i, grad_center_i, grad_outside_i = word2vec_loss_and_gradient(
        center_word_vec, word2ind[outside_word], outside_vectors, dataset)
    loss += loss_i
